...
const stylesheet = StyleSheet.create({
  ...
  style_Group_512: {
    ...
    height: 99,
    transform: [{ translateX: 20 }, { translateY: 423 }, { rotate: '0deg' }],
    overflow: 'hidden',
    backgroundColor: 'rgba(0,0,0,0)'
  },
  style_Group_508: {
  ...
  style_Group_511: {
    ...
    width: Dimensions.get("window").width - 40,
    height: 69,
    transform: [{ translateX: 20 }, { translateY: 334 }, { rotate: '0deg' }],
    overflow: 'hidden',
    backgroundColor: 'rgba(0,0,0,0)'
  },
  style_____________2: {
  ...
  style_Group_514: {
    ...
    width: Dimensions.get("window").width - 40,
    height: 65,
    transform: [{ translateX: 20 }, { translateY: 617 }, { rotate: '0deg' }],
    overflow: 'hidden',
    backgroundColor: 'rgba(0,0,0,0)'
  },
