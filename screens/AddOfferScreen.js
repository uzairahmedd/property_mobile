...
export default function AddOfferScreen() {
  ...
  return (
    ...
    >
      <View style={stylesheet.style_AddOfferScreen}>
        <Image
        ...
        <View
          style={[
            stylesheet.style______________________________________________________,
            { display: "flex", flexDirection: "row", alignItems: "center" },
          ]}
        >
          <Text
          ...
          >
            يرجى التأكد من صحة المعلومات لتأكيد اشتراكك في المزاد
          </Text>
        </View>
        ...
        <View style={stylesheet.style_Group_469}>
          <View
            style={[
              stylesheet.style_________________________4_5____________,
              { display: "flex", flexDirection: "row", alignItems: "center" },
            ]}
          >
            <Text
            ...
            >
              السعر المعروض ( حد أدنى 4.5 مليون ر.س )
            </Text>
          </View>
...
const stylesheet = StyleSheet.create({
  ...
  style_________________________4_5____________: {
    position: "absolute",
    // width: "auto",
    // height: "auto",
    left: 103,
...
const imageUrlstyle_Rectangle_64 =
  "https://sizze-figma-plugin-images-upload.s3.us-east-2.amazonaws.com/7ed3c440563c83ba748409c1c7209c0f";
