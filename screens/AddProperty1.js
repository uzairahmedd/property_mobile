...
const stylesheet = StyleSheet.create({
  ...
  style_Group_468: {
    ...
    height: 48,
    transform: [{ translateX: 10 }, { translateY: 716 }, { rotate: '0deg' }],
    overflow: 'hidden',
  ...
  style_Group_511: {
    ...
    width: Dimensions.get("window").width - 20,
    height: 65,
    transform: [{ translateX: 10 }, { translateY: 359 }, { rotate: '0deg' }],
    overflow: 'hidden',
    backgroundColor: 'rgba(0,0,0,0)'
  },
  style_____________: {
  ...
  style_Group_512: {
    ...
    width: Dimensions.get("window").width - 20,
    height: 115,
    transform: [{ translateX: 10 }, { translateY: 448 }, { rotate: '0deg' }],
    overflow: 'hidden',
    backgroundColor: 'rgba(0,0,0,0)'
  },
